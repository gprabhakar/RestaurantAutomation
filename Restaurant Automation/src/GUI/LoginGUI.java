...
public class LoginGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Team One Restaurant Automation");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String auth=Cg.sendCredentials(ID,pass);
        if(auth.equals("invalid"))
           jLabel4.setText("Invalid ID! Please enter correct UserID!");
        else if(auth.equals("true"))
        {
           this.setVisible(false);
            ...
            jLabel4.setText("Invalid password! Please enter correct password!");
